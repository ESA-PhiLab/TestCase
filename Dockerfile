...
RUN pip install streamlit_toggle
COPY ./DG5A /workspace/project
WORKDIR /workspace/project
EXPOSE 80
ENTRYPOINT ["streamlit", "run", "streamlit_app_spacelaw_bot.py", "--server.port=80", "--server.fileWatcherType=none"]
